...
- **Hosting: NETLIFY** (GitHub Pages CDN bị hỏng vĩnh viễn — KHÔNG dùng nữa)
...
| Mục | Giá trị |
|-----|---------|
| Website (NETLIFY — DÙNG CÁI NÀY) | https://xbg-dashboard.netlify.app |
| Website cũ (GitHub Pages — BỊ HỎNG) | https://thangtru123-svg.github.io/Th-ng/ |
...
4. Commit + Push qua GitHub Desktop → **Netlify tự động deploy** (không cần làm gì thêm)
...
| Lỗi | Xử lý |
|-----|-------|
| GitHub Pages CDN bị stuck (deployment_queued mãi) | Đã chuyển sang Netlify — KHÔNG cần sửa GitHub Pages nữa |
| Google OAuth `origin_mismatch` khi đổi domain | Vào Google Cloud Console → OAuth credentials → thêm domain mới vào Authorized JS Origins |
